...
namespace Task4_5
{
    class Program
    {
        ...
        static double DoOperation(double operand1, double operand2, MathOperation operation)
        {
            switch(operation)
            {
        ...
        static void Main()
        {
            ...
            Console.WriteLine($"В {monthNames[month-1]} {year} года {days} {(((days % 10) == 1) ? "день" : "дней")} ");
            Console.ReadKey();
        }
    }
}
